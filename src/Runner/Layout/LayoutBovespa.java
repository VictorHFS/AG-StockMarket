...
public class LayoutBovespa {
	...
	public Runner.Layout.Registro tipoDeRegistro(String registro) {
		if (registro.startsWith("00")) {
			return Runner.Layout.Registro.Header;
		}
		if (registro.startsWith("01")) {
			return Runner.Layout.Registro.Contacao;
		}
		if (registro.startsWith("99")) {
			return Runner.Layout.Registro.Trailer;
		}
		return null;
	}
